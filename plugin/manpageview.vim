...
if !exists("g:manpageview_pgm_upl")
 let g:manpageview_pgm_upl     = "perldoc"
 let g:manpageview_options_upl = ""
 let g:manpageview_sfx_upl     = ".pl"
endif
if !exists("g:manpageview_pgm_pm")
...
"   call Decho("win32: manpagebook<".manpagebook."> topic<".manpagetopic.">")
   exe cmdmod."r!rsh g:manpageview_server -l g:manpageview_user ".pgm." ".opt." ".manpagebook." ".manpagetopic
   exe cmdmod.'silent!  %s/.\b//ge'

" elseif has("conceal")
"  exe cmdmod."r!".pgm." ".opt." ".manpagebook." ".manpagetopic
...
"   call Decho("not win32: manpagebook<".manpagebook."> topic<".manpagetopic.">")
"   call Decho("executing ".cmdmod."r!".pgm." ".opt." ".manpagebook." '".manpagetopic."'")
   exe cmdmod."r!".pgm." ".opt." ".manpagebook." '".manpagetopic."'"
   exe cmdmod.'silent!  %s/.\b//ge'
  endif

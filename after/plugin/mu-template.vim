...
"
" Last Update:  11th Jun 2004
" Version:	0.34, by Luc Hermitte <hermitte {at} free {dot} fr>
" 
...
"	Documentation: finish. ; document new function Author
...
function! s:Include(template, ...)
  ...
  let cmd = ':SearchInVar g:mt_templates_dirs '.(pos-correction).
  ...
  let s:last = s:last + line("']") - pos + correction
endfunction
